...
abstract contract UniswapV4Module {
    ...
    function _swapForLpComposition(
        ...
        IERC20(borrowAsset).approve(address(swapRouter), 0);
        IERC20(borrowAsset).approve(address(swapRouter), half);
        ...
        uint256 amountOut = swapRouter.swapExactInputSingle(params);
